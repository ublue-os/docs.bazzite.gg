...
Bazaar is the **primary method of installing applications on Bazzite** _(outside of the small selection of software available in the [Bazzite Portal or as a `ujust` command](./ujust.md))_  and is recommended to use over other formats for most software when possible.  Bazaar uses [Flatpaks]() from [Flathub]().
