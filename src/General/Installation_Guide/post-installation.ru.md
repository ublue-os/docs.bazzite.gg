...
![Меню GRUB с двумя состояниями системы и настройками прошивки UEFI](../../img/GRUB_Menu.png)

При первом запуске появится экран с текущим и предыдущим состояниями системы. Если возникнут проблемы, через меню GRUB можно откатить Bazzite к предыдущему состоянию.
