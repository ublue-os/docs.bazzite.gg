...
# Instalace Bazzite pro hardware HTPC
...
- Moderní AMD GPU
  -GPU Intel Arc mohou fungovat s **menšími výhradami**
  - GPU Nvidia jsou aktuálně ve verzi beta s **hlavními výhradami**
- Účet [Steam](https://store.steampowered.com/).
...
Současní uživatelé [Fedora Atomic Desktop](https://fedoraproject.org/atomic-desktops/) mohou provést rebase pomocí příkazu terminálu uvedeného na webu v části „Stávající uživatelé Fedora Atomic Desktop“ a mohou přeskočit další krok.
...
Než budete pokračovat, přečtěte si [Dual Boot Guide](https://universal-blue.discourse.group/docs?topic=2743) **po** přečtení této příručky.
...
**Viz také:** [Průvodce ručním rozdělením proti proudu](https://docs.fedoraproject.org/en-US/fedora-silverblue/installation/#manual-partition) & [Přehled herního režimu Steam][Steam_Gaming_Mode]
