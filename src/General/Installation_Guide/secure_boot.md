...
- Secure Boot is incompatible with [CSM (Compatibility Support Module) / legacy](../General/FAQ.md#does-bazzite-support-csmlegacy-boot) mode. Make sure it is **disabled** and neither set to enabled or auto.
