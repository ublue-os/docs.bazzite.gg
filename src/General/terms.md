...
# Dictonary & Terminology

## General

-   **[[Desktop] Linux](https://www.ubuntudocs.com/bdesktop/)** <small>[Internet Archive Backup](https://web.archive.org/web/20240813064251/https://www.ubuntudocs.com/bdesktop/)</small>: A family of operating systems that share many of the same core software including the [Linux kernel](https://www.kernel.org/), [systemd](https://systemd.io/) and the [GNU core utilities](https://www.gnu.org/software/coreutils/).
...
-   **[Steam Gaming Mode](https://github.com/bazzite-org/gamescope-session)**: A session that runs Steam's Big Picture Mode user interface inside of Gamescope.  Also known as *Game Mode*.
...
-   [**Vulkan**](https://www.vulkan.org/): Cross-platform, open standard graphics API derived from AMD's Mantle as an alternative to DirectX, which is Windows exclusive. Most applications on Linux(including Windows apps ran through Proton) use the Vulkan API.
-   [**OpenGL**](https://www.opengl.org/): Legacy graphics API when Vulkan is not available. On new Intel ARC Graphics cards, there are no native OpenGL driver and OpenGL apps are translated to Vulkan via the [Zink Mesa Gallium Driver](https://docs.mesa3d.org/drivers/zink.html).
...
-   **[InputPlumber](https://github.com/shadowblip/InputPlumber)**: An open source input routing and control daemon for Linux. It can be used to combine any number of input devices (like gamepads, mice, and keyboards) and translate their input to a variety of virtual device formats.
-   **[OpenGamepadUI](https://github.com/ShadowBlip/OpenGamepadUI)**: A free and open source game launcher and overlay, designed with a gamepad native experience in mind. It implements a gamepad input system that allows remapping gamepad input to mouse and keyboard inputs.
-   **[Universal Blue](https://ublue.it)**: A FOSS collective that specializes in custom Fedora images.
-   **[Bootable Container Image](https://docs.fedoraproject.org/en-US/bootc/getting-started/)**: Software and services are packaged inside of a container that run on top of an existing operating system (like Fedora) as as a means of delivering a specialized operating system.  Also known as a [*custom image*](../Advanced/creating_custom_image.md).
...
!!! info
    ...
    [**Handheld Daemon (HHD)**](https://github.com/hhd-dev/hhd), which previously handled handheld hardware-enablement, controller functionality, power utilization, RGB, and other functions is being phased out in the Bazzite 44 release in favor of OpenGamepadUI and InputPlumber, as detailed [here](https://universal-blue.discourse.group/t/a-brighter-future-for-bazzite/11575)
