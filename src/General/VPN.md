...
-   [Using Tailscale with Mullvad](https://tailscale.com/kb/1258/mullvad-exit-nodes) - Provides the best out of the box experience.
  ...
  -   The **Enable Tailscale** option in **Bazzite Portal** will remove the built in desktop integration if you prefer to use something else.
  -   Tailscale's [YouTube channel](https://www.youtube.com/@Tailscale) has lots of great tips and tricks.
-   Good VPNs should provide Wireguard configuration files that can be imported directly into NetworkManager, check your VPN provider's documentation for more information.
-   Only [layer the VPN with rpm-ostree](/Installing_and_Managing_Software/rpm-ostree/) as a last resort .
